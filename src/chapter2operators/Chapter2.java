...
import static chapter2operators.PassObject.f;
...
public class Chapter2 {
    ...
    public static void main(String[] args) {
        ...
        /** Exercise 10: (3)  Write a program with two constant values, one with alternating binary ones and
         ...
         *      @see StringCompare
         */
        StringCompare compareString = new StringCompare();
